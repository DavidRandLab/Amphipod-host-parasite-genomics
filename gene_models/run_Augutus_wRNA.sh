...
#SBATCH -J Augustus_RNA_informed_predictions
#SBATCH -n 1
#SBATCH --mem=80GB
#SBATCH -t 190:00:00
...
PROJECT=Ogril1_1k_masked_RNAevidence
reference=~/data/O_grillus_genomic_resources/Genomes/Masked_genome/Masker_output/Ogril1.1Kmin.masked.fasta
BAM=~/scratch/Eco_genomics_class/Amphipod/RNA_reads/flt.srt.Amphi.uninfc.bam
CPU=6
...
augustus --species=fly --extrinsicCfgFile=extrinsic.M.RM.E.W.P.cfg --alternatives-from-evidence=true --hintsfile=Ogril1_RNAprior.hints.Iterated.gff --allow_hinted_splicesites=atac --gff3=on $reference > $PROJECT.iteratedHints.gff3
