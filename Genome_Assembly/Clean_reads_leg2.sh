...
#SBATCH -J SGA_filtering_on_amphi_Leg2
#SBATCH -n 6
#SBATCH --mem=120GB
#SBATCH -t 72:00:00
...
forward=~/igert/amphipods/raw_data/GENEWIZ_JULY2016/DNAseq/Leg_2-Zymo_S54_L008_R1_001.fastq.gz
#Reverse Reads of the PE set. These should be in FastQ format
reverse=~/igert/amphipods/raw_data/GENEWIZ_JULY2016/DNAseq/Leg_2-Zymo_S54_L008_R2_001.fastq.gz
#File indentifier. This is the name given to the output files
#NOTE=avoid "." at the end of the workid.
workid=amphi_2_leg_q20_l5_r140
