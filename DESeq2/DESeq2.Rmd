...
FDR.CUT <- params$FDR
LFC.CUT <- params$LFC
setwd("/Users/davidrand/Dropbox (Brown)/Teaching/Grad Seminar/Ecological and Evolutionary Genomics 2019/Amphipod paper/DESeq2_2023_redo/")
...
DEtable_InfectionStatus_Genome_DESeq %>%
  write_csv('DEtable_InfectionStatus_Genome_DESeq.csv')
...
GO_upGenes_InfectionStatus_Genome_DESeq %>%
  write_csv('GO_upGenes_InfectionStatus_Genome_DESeq.csv')
...
GO_downGenes_InfectionStatus_Genome_DESeq %>%
  write_csv('GO_downGenes_InfectionStatus_Genome_DESeq.csv')
