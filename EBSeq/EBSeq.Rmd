...
FDR.CUT <- params$FDR
LFC.CUT <- params$LFC
setwd("/Users/davidrand/Dropbox (Brown)/Teaching/Grad Seminar/Ecological and Evolutionary Genomics 2019/Amphipod paper/EBSeq_2023_redo")
```
...
DEtable_InfectionStatus_Genome_EBSeq %>%
  write_csv('DEtable_InfectionStatus_Genome_EBSeq.csv')
...
GO_upGenes_InfectionStatus_Genome_EBSeq %>%
  write_csv('GO_upGenes_InfectionStatus_Genome_EBSeq.csv')
...
GO_downGenes_InfectionStatus_Genome_EBSeq %>%
  write_csv('GO_downGenes_InfectionStatus_Genome_EBSeq.csv')
...
```{r fig.height=12, fig.width=8, echo=TRUE}
...
ReactomeTable_InfectionStatus_Genome_EBSeq %>%
  write_csv('ReactomeTable_InfectionStatus_Genome_EBSeq.csv')
...
slimmed %>%
  write_csv('Tables/GO_slimmed_InfectionStatus_Genome_EBSeq.csv')
